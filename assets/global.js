...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    this.isVertical = this.dataset.direction === 'vertical';
    this.initPages();
  ...
  initPages() {
    ...
    // For mobile slider, each item takes full width
    if (window.innerWidth < 750 && this.slider.classList.contains('slider--mobile')) {
      this.sliderItemOffset = this.slider.clientWidth;
  ...
  update() {
    ...
    const scrollPosition = this.isVertical && window.innerWidth > 750 ? this.slider.scrollTop : this.slider.scrollLeft;
  ...
  isSlideVisible(element, offset = 0) {
    if (this.isVertical && window.innerWidth > 750) {
  ...
  onButtonClick(event) {
    ...
    this.slideScrollPosition =
      event.currentTarget.name === 'next'
        ? scrollPosition + step * this.sliderItemOffset
        : scrollPosition - step * this.sliderItemOffset;
